...
typedef SetRangeActionCallback = Function(
    {DateTime? startDate, DateTime? endDate, int? mode});
...
class _DatePickerWithPeriodeState
    extends State<DatePickerWithSelectRange> {
                    ...
                    children: [
                      Material(
                        ...
                        shape: RoundedRectangleBorder(
                          side: BorderSide(color: modes == 1 ? const Color(0xFF00529C) : const Color(0xFFE5E5E6), width: 2),
                      ...
                      Material(
                        color: const Color(0xFFF8F7F7),
                        shape: RoundedRectangleBorder(
                          side: BorderSide(color:  modes == 2 ? const Color(0xFF00529C) : const Color(0xFFE5E5E6), width: 2),
                          borderRadius: BorderRadius.circular(4.0)
                        ),
                        child: InkWell(
                          hoverColor: const Color(0xFFFF6500).withOpacity(0.2),
                      ...
                      Material(
                        color: const Color(0xFFF8F7F7),
                        shape: RoundedRectangleBorder(
                          side: BorderSide(color:  modes == 3 ? const Color(0xFF00529C) : const Color(0xFFE5E5E6), width: 2),
                          borderRadius: BorderRadius.circular(4.0)
                        ),
                        child: InkWell(
                          hoverColor: const Color(0xFFFF6500).withOpacity(0.2),
                          ...
                          Expanded(
                            child: Stack(children: [
                              Positioned.fill(
                                ...
                                child: ValueListenableBuilder<DateRangePickerView?>(
